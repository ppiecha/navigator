...
class MainFrame(wx.Frame):
    def __init__(self):
        super().__init__(parent=None, title=cn.CN_APP_NAME, size=(400, 400), style=wx.DEFAULT_FRAME_STYLE)
    ...
    def InitUI(self):
        ...
        self.left_browser = browser.BrowserPnl(self.splitter, self, self.im_list, self.app_conf.left_browser)
        self.right_browser = browser.BrowserPnl(self.splitter, self, self.im_list, self.app_conf.right_browser)
